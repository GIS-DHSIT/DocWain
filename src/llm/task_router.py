...
_TASK_OPTIONS: Dict[TaskType, Dict[str, Any]] = {
    ...
    TaskType.RESPONSE_GENERATION:   {"temperature": 0.3,  "num_predict": 2048, "num_ctx": 8192},
    TaskType.STRUCTURED_EXTRACTION: {"temperature": 0.05, "num_predict": 2048, "num_ctx": 8192},
    TaskType.TOOL_EXECUTION:        {"temperature": 0.2,  "num_predict": 2048, "num_ctx": 8192},
    TaskType.ANSWER_JUDGING:        {"temperature": 0.05, "num_predict": 512,  "num_ctx": 8192},
    TaskType.GROUNDING_VERIFY:      {"temperature": 0.05, "num_predict": 1024, "num_ctx": 4096},
    TaskType.CONTENT_GENERATION:    {"temperature": 0.7,  "num_predict": 2048, "num_ctx": 12288},
    TaskType.QUERY_CLASSIFICATION:  {"temperature": 0.0,  "num_predict": 512,  "num_ctx": 4096},
    TaskType.CONVERSATION_SUMMARY:  {"temperature": 0.2,  "num_predict": 512,  "num_ctx": 4096},
    TaskType.DOCUMENT_UNDERSTANDING: {"temperature": 0.1, "num_predict": 1024, "num_ctx": 4096},
    TaskType.COMPLEX_EXTRACTION:    {"temperature": 0.2, "num_predict": 2048, "num_ctx": 12288},
    TaskType.AGENT_REASONING:       {"temperature": 0.05, "num_predict": 512,  "num_ctx": 8192},
