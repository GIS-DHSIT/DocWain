...
class Config:
    ...
    class Model:
        ...
        AZURE_OPENAI_ENDPOINT = "https://dw-openai-dev.openai.azure.com/"
        AZURE_DEPLOYMENT_NAME = "dw-dev1-gpt-4o"
        AZURE_OPENAI_API_KEY = '6JSK5oHMv76xL6IAtFwVfgCRykf24MWdvp6oRpxawBk9sGyqXuQYJQQJ99BCACmepeSXJ3w3AAABACOGjB0M'
